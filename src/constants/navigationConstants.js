...
// ECOMMERCE FLOW
export const ECOMMERCE_FLOW = 'ECOMMERCE_FLOW';
export const ECOMMERCE_GREET = 'ECOMMERCE_GREET';
export const ECOMMERCE_OFFERS = 'OFFERS';
export const ECOMMERCE_ITEM_DETAIL = 'ECOMMERCE_ITEM_DETAIL';
export const ECOMMERCE_CHECKOUT = 'ECOMMERCE_CHECKOUT'
export const ECOMMERCE_PAYMENT_CONFIRM = 'ECOMMERCE_PAYMENT_CONFIRM'
